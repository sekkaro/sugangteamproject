...
<body>
	...
	<div id="div1">
		<h1 style="text-align: center;">과목 수정</h1>
	</div>
		...
		<table id="list">
			...
			<tr>
				...
				<td><input id="time" class="form-control" type="text"
					name="time" value="${u.time}" /></td>
			</tr>

			<tr>
				<td>성적유형</td>
				<td><select id="type" class="form-control" name="type"><option
							value="0" <c:if test="${u.type == 0}">selected</c:if>>A+</option>
						<option value="1" <c:if test="${u.type == 1}">selected</c:if>>P/F</option></select></td>
			</tr>

			<tr>
				<td>정원</td>
				<td><input id="capacity" class="form-control" type="text"
					name="capacity" value="${u.capacity}" /></td>
			</tr>

			<tr>
				<td>교수님</td>
				<td><input id="professor" class="form-control" type="text"
					name="professor" value="${u.professor}"/></td>
			</tr>

			<tr>
				<td>학점</td>
				<td><input id="credits" class="form-control" type="text"
					name="credits" value="${u.credits}" /></td>
			</tr>
		</table>
