...
<div class="w3-top">
  <div class="w3-bar w3-indigo w3-wide w3-padding w3-card">
    ...
    <a href="mypage" class="w3-bar-item w3-button">마이 페이지<i class="far fa-user"></i></a>
    </c:if>
...
<c:forEach items="${list}" var="u">
	<tr>
		...
		<td><a href="deleteok/${u.getSeq()}">삭제</a></td>
		</c:if>
		<c:if test="${user.getType() == 1}">
		<td><a href="applyform/${u.getSeq()}">수강 신청</a></td>
		</c:if>
	</tr>
</c:forEach>
</table>
